...
import { AdvanceModel, SalaryModel, UserModel } from "src/database/models";
...
export class AdvanceController {
    ...
    constructor(
        private readonly advanceModel: AdvanceModel,
    ...
    async index(
        ...
        try {
            ...
            let [ salaries, count ] = await this.advanceModel.findAndCount({ society: user.society },{ populate: ['user'], ...options });
    ...
    async store(
        ...
        try {
            ...
            await this.advanceModel.save(body);
    ...
    async fetch(
        ...
        try {
            // Fetch all expense types
            let salary = await this.advanceModel.find({});
