...
export default class PermissionModel extends EntityRepository<PermissionEntity>{
  constructor(
    /**
    ...
    private repository: EntityRepository<PermissionEntity>,
  ) {
    super(repository.getEntityManager(), PermissionEntity) 
  }
