...
export default class CustomerModel extends EntityRepository<CustomerEntity>{
  constructor(
    /**
    ...
    private repository: EntityRepository<CustomerEntity>,
  ) {
    super(repository.getEntityManager(), CustomerEntity) 
  }
