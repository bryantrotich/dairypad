...
export default class SalaryModel extends EntityRepository<SalaryEntity>{
  constructor(
    /**
    ...
    private repository: EntityRepository<SalaryEntity>,
  ) {
    super(repository.getEntityManager(), SalaryEntity) 
  }
