...
import { TransporterEntity } from '../entities';
...
export default class TransporterModel extends EntityRepository<TransporterEntity>{
  constructor(
    /**
    ...
    private repository: EntityRepository<TransporterEntity>,
  ) {
    super(repository.getEntityManager(), TransporterEntity) 
  }
